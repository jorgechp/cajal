...
include_once (ROOT .'/Interfaces/dao/IActividadCategoriaDAO.php');
include_once (ROOT .'/objects/ActivityTipo.php');
 ...
 * @author jorge
 */
abstract class ActividadCategoriaDAO extends DaoClass implements IActividadCategoriaDAO {
