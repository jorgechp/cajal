...
include_once (ROOT .'/Interfaces/dao/IActividadDAO.php');
include_once (ROOT .'/objects/Activity.php');
 ...
 * @author jorge
 */
abstract class ActividadDAO extends DaoClass implements IActividadDAO {
